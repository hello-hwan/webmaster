...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "JAVA"."BOARD_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 821 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into JAVA.BOARD (BOARD_NO,BOARD_CATEGORY,BOOK_NO,SECRET_FLAG,TITLE,CONTENT,NOTICE_FLAG,BOARD_FILE,WRITER,VIEW_CNT,WRITE_DATE,REPLY_NO,BOARD_PW) values (3001,'notice',null,0,'필수공지사항 1/5','첫번째 공지사항입니다. 1002번 caraban, 1004번 auto, 109번 deck는 현재 사용불가합니다.',1,null,'admin101',4,to_date('24/10/30','RR/MM/DD'),null,3001);
Insert into JAVA.BOARD (BOARD_NO,BOARD_CATEGORY,BOOK_NO,SECRET_FLAG,TITLE,CONTENT,NOTICE_FLAG,BOARD_FILE,WRITER,VIEW_CNT,WRITE_DATE,REPLY_NO,BOARD_PW) values (3002,'notice',null,0,'필수공지사항 2/5','두번째 공지사항입니다. 1002번 caraban, 1004번 auto, 109번 deck는 현재 사용불가합니다.',1,null,'kim_sazang',891,to_date('24/10/30','RR/MM/DD'),null,3002);
Insert into JAVA.BOARD (BOARD_NO,BOARD_CATEGORY,BOOK_NO,SECRET_FLAG,TITLE,CONTENT,NOTICE_FLAG,BOARD_FILE,WRITER,VIEW_CNT,WRITE_DATE,REPLY_NO,BOARD_PW) values (3003,'notice',null,0,'필수공지사항 3/5','세번째 공지사항입니다. 필수 공지사항은 notice_flag 값이 1입니다.',1,null,'kim_sazang',892,to_date('24/10/30','RR/MM/DD'),null,3003);
Insert into JAVA.BOARD (BOARD_NO,BOARD_CATEGORY,BOOK_NO,SECRET_FLAG,TITLE,CONTENT,NOTICE_FLAG,BOARD_FILE,WRITER,VIEW_CNT,WRITE_DATE,REPLY_NO,BOARD_PW) values (3004,'notice',null,0,'필수공지사항 4/5','네번째 공지사항입니다. 필수 공지사항은 permission이 admin인 admin101 사용자만 작성할 수 있습니다.',1,null,'kim_sazang',669,to_date('24/10/30','RR/MM/DD'),null,3004);
Insert into JAVA.BOARD (BOARD_NO,BOARD_CATEGORY,BOOK_NO,SECRET_FLAG,TITLE,CONTENT,NOTICE_FLAG,BOARD_FILE,WRITER,VIEW_CNT,WRITE_DATE,REPLY_NO,BOARD_PW) values (3005,'notice',null,0,'필수공지사항 5/5','다섯번째 공지사항입니다. 필수 공지는 5가지입니다.',1,null,'kim_sazang',796,to_date('24/10/30','RR/MM/DD'),null,3005);
Insert into JAVA.BOARD (BOARD_NO,BOARD_CATEGORY,BOOK_NO,SECRET_FLAG,TITLE,CONTENT,NOTICE_FLAG,BOARD_FILE,WRITER,VIEW_CNT,WRITE_DATE,REPLY_NO,BOARD_PW) values (3006,'notice',null,0,'일반공지사항 1/2','첫번째 일반공지사항입니다. 예약번호 0번에 일반공지사항을 넣겠습니다.',0,null,'kim_sazang',124,to_date('24/10/30','RR/MM/DD'),null,3006);
Insert into JAVA.BOARD (BOARD_NO,BOARD_CATEGORY,BOOK_NO,SECRET_FLAG,TITLE,CONTENT,NOTICE_FLAG,BOARD_FILE,WRITER,VIEW_CNT,WRITE_DATE,REPLY_NO,BOARD_PW) values (3007,'notice',null,0,'일반공지사항 2/2','두번째 일반공지사항입니다. 일반 공지사항은 notice_flag 값이 0입니다.',0,null,'kim_sazang',458,to_date('24/10/30','RR/MM/DD'),null,3007);
Insert into JAVA.BOARD (BOARD_NO,BOARD_CATEGORY,BOOK_NO,SECRET_FLAG,TITLE,CONTENT,NOTICE_FLAG,BOARD_FILE,WRITER,VIEW_CNT,WRITE_DATE,REPLY_NO,BOARD_PW) values (3011,'qna','2001',0,'문의사항 1/3','예약번호 2001번의 문의사항입니다. 삼겹살도 파나요?',0,null,'kim_hama',780,to_date('24/10/30','RR/MM/DD'),null,3011);
...
Insert into JAVA.BOARD (BOARD_NO,BOARD_CATEGORY,BOOK_NO,SECRET_FLAG,TITLE,CONTENT,NOTICE_FLAG,BOARD_FILE,WRITER,VIEW_CNT,WRITE_DATE,REPLY_NO,BOARD_PW) values (3013,'qna','2002',1,'문의사항 2/3','예약번호 2002번의 문의사항입니다. 바베큐 공짜로 해주면 리뷰써줌',0,null,'kim_girin',778,to_date('24/10/30','RR/MM/DD'),null,3013);
...
Insert into JAVA.BOARD (BOARD_NO,BOARD_CATEGORY,BOOK_NO,SECRET_FLAG,TITLE,CONTENT,NOTICE_FLAG,BOARD_FILE,WRITER,VIEW_CNT,WRITE_DATE,REPLY_NO,BOARD_PW) values (3015,'qna','2003',0,'문의사항 3/3','예약번호 2003번의 문의사항입니다. 입구에 레드카펫좀 깔아주세요.',0,null,'kim_tokki',779,to_date('24/10/30','RR/MM/DD'),null,3013);
Insert into JAVA.BOARD (BOARD_NO,BOARD_CATEGORY,BOOK_NO,SECRET_FLAG,TITLE,CONTENT,NOTICE_FLAG,BOARD_FILE,WRITER,VIEW_CNT,WRITE_DATE,REPLY_NO,BOARD_PW) values (3016,'reply','2001',0,'문의사항 3/3_답변','예약번호 2003번의 답변입니다. 추가비용 150000원 입니다.',0,null,'kim_sazang',779,to_date('24/10/30','RR/MM/DD'),3015,3016);
Insert into JAVA.BOARD (BOARD_NO,BOARD_CATEGORY,BOOK_NO,SECRET_FLAG,TITLE,CONTENT,NOTICE_FLAG,BOARD_FILE,WRITER,VIEW_CNT,WRITE_DATE,REPLY_NO,BOARD_PW) values (3021,'review','2001',0,'리뷰 1/3','예약번호 2001번의 후기입니다. 잘놀다 갑니다. 별점 4점',0,null,'kim_hama',779,to_date('24/10/30','RR/MM/DD'),null,3021);
Insert into JAVA.BOARD (BOARD_NO,BOARD_CATEGORY,BOOK_NO,SECRET_FLAG,TITLE,CONTENT,NOTICE_FLAG,BOARD_FILE,WRITER,VIEW_CNT,WRITE_DATE,REPLY_NO,BOARD_PW) values (3022,'review','2002',0,'리뷰 2/3','예약번호 2002번의 후기입니다. 간단한 요구도 안들어줍니다. 오지마세요. 별점 1점.',0,null,'kim_girin',778,to_date('24/10/30','RR/MM/DD'),null,3022);
Insert into JAVA.BOARD (BOARD_NO,BOARD_CATEGORY,BOOK_NO,SECRET_FLAG,TITLE,CONTENT,NOTICE_FLAG,BOARD_FILE,WRITER,VIEW_CNT,WRITE_DATE,REPLY_NO,BOARD_PW) values (3023,'review','2003',0,'리뷰 3/3','예약번호 2003번의 후기입니다. 사장이 돈에 미쳤어요. 별점 3점',0,null,'kim_tokki',781,to_date('24/10/30','RR/MM/DD'),null,3023);
Insert into JAVA.BOARD (BOARD_NO,BOARD_CATEGORY,BOOK_NO,SECRET_FLAG,TITLE,CONTENT,NOTICE_FLAG,BOARD_FILE,WRITER,VIEW_CNT,WRITE_DATE,REPLY_NO,BOARD_PW) values (802,'notice',null,0,'test','test!!!',1,null,'admin101',2,to_date('24/11/01','RR/MM/DD'),null,0);
Insert into JAVA.BOARD (BOARD_NO,BOARD_CATEGORY,BOOK_NO,SECRET_FLAG,TITLE,CONTENT,NOTICE_FLAG,BOARD_FILE,WRITER,VIEW_CNT,WRITE_DATE,REPLY_NO,BOARD_PW) values (803,'notice',null,0,'test1','test11111',0,null,'admin101',0,to_date('24/11/01','RR/MM/DD'),null,0);
Insert into JAVA.BOARD (BOARD_NO,BOARD_CATEGORY,BOOK_NO,SECRET_FLAG,TITLE,CONTENT,NOTICE_FLAG,BOARD_FILE,WRITER,VIEW_CNT,WRITE_DATE,REPLY_NO,BOARD_PW) values (804,'notice',null,0,'test112222','test11111111',0,null,'admin101',0,to_date('24/11/01','RR/MM/DD'),null,0);
Insert into JAVA.BOARD (BOARD_NO,BOARD_CATEGORY,BOOK_NO,SECRET_FLAG,TITLE,CONTENT,NOTICE_FLAG,BOARD_FILE,WRITER,VIEW_CNT,WRITE_DATE,REPLY_NO,BOARD_PW) values (805,'notice',null,0,'22','222222222',1,null,'admin101',0,to_date('24/11/01','RR/MM/DD'),null,0);
Insert into JAVA.BOARD (BOARD_NO,BOARD_CATEGORY,BOOK_NO,SECRET_FLAG,TITLE,CONTENT,NOTICE_FLAG,BOARD_FILE,WRITER,VIEW_CNT,WRITE_DATE,REPLY_NO,BOARD_PW) values (806,'notice',null,0,'333','3333',0,null,'admin101',0,to_date('24/11/01','RR/MM/DD'),null,0);
...
Insert into JAVA.MEMBER (MEMBER_ID,PASSWORD,MEMBER_NAME,ADDRESS,EMAIL,TEL,JOINED_DATE,PERMISSION) values ('test1','0000','테스트','서울 강남구 신사동 536-9','abc@gmail.com','010-1234-5678',to_date('24/11/01','RR/MM/DD'),'user');
Insert into JAVA.MEMBER (MEMBER_ID,PASSWORD,MEMBER_NAME,ADDRESS,EMAIL,TEL,JOINED_DATE,PERMISSION) values ('test2','0000','테스트용','대구 군위군 군위읍 내량리 1142-2','abce@gmail.com','010-4578-4512',to_date('24/11/01','RR/MM/DD'),'user');
...
SET DEFINE OFF;
Insert into JAVA.SITE_BOOK (BOOK_NO,MEMBER_ID,SITE_NO,MEM_CNT,START_DATE,END_DATE,CAR_NUM,TOTAL_PRICE,REVIEW_FLAG,CANCEL_FLAG,CREATE_DATE) values (2001,'mid901',1001,3,'2024/10/10 13:00:00','2024/10/11 10:00:00','대구31가1010',150000,1,0,to_date('24/10/30','RR/MM/DD'));
...
Insert into JAVA.SITE_BOOK (BOOK_NO,MEMBER_ID,SITE_NO,MEM_CNT,START_DATE,END_DATE,CAR_NUM,TOTAL_PRICE,REVIEW_FLAG,CANCEL_FLAG,CREATE_DATE) values (101,'mid901',1005,2,'2024-11-05','2024-11-07','1818',25000,0,0,to_date('24/11/01','RR/MM/DD'));
